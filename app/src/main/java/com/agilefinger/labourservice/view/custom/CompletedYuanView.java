...
public class CompletedYuanView extends View {
    ...
    public CompletedYuanView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CompletedYuanView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public CompletedYuanView(Context context) {
        this(context,null);
    }
