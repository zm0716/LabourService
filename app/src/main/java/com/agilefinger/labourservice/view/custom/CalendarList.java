...
import com.agilefinger.labourservice.bean.DateBean;
...
//                    vh.itemView.setBackgroundColor(Color.parseColor("#ff6600"));
                    vh.itemView.setBackgroundResource(R.drawable.date_check);
                    ...
                    //选中状态
                    vh.itemView.setBackgroundColor(Color.parseColor("#d6ecff"));
                    vh.tv_day.setTextColor(Color.WHITE);
                } else {
                    //正常状态
...
//            calendar.setTime(startDate);
            ...
            //结束日期
            calendar.add(Calendar.MONTH, -(2 * 12));
