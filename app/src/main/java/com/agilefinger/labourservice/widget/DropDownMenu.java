package com.agilefinger.labourservice.widget;
...
public class DropDownMenu extends LinearLayout {
    ...
    private DropDownMenuCallback callbackListener;
     ...
     * @param contentView
     */
    public void setDropDownMenu(DropDownMenuCallback callbackListener, @NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView, int type) {
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) (ScreenUtils.getScreenSize(getContext())[1] * menuHeighPercent)));
