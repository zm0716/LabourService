...
public class PathUtil {
    ...
    public static String getSavePath() {
        ...
        if (EaseCommonUtils.isSdcardExist()) {
            path = Environment.getExternalStorageDirectory().toString() + File.separator + "MGJ-IM" + File.separator + folder + File.separator;
        } else {
            path = Environment.getDataDirectory().toString() + File.separator + "MGJ-IM" + File.separator + folder + File.separator;
        }
        return path;
    }
}
