 ...
 */
public class DropDownMenuO extends LinearLayout {
    ...
    public DropDownMenuO(Context context) {
        super(context, null);
    }

    public DropDownMenuO(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DropDownMenuO(Context context, AttributeSet attrs, int defStyleAttr) {
