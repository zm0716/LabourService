...
public class TuiJian2Adapter extends RecyclerView.Adapter<TuiJianHolder>{
    ...
    private int mFoot=1;
    public TuiJian2Adapter(Context context, List<PicBean> list) {
    ...
    public TuiJianHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_zg_images2, parent,false);
